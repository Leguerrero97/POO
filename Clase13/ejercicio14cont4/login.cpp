...
Login::Login(QWidget *parent) : QWidget(parent), adminDB(new AdminDB(this)),
    ...
    // Conectar señal de validación exitosa
...
void Login::handleLogin() {
    ...
    if (!datosPersonales.isEmpty()) {
        emit signal_usuarioValidado(username);
        // ... (Aquí puedes usar los datos personales obtenidos: datosPersonales[0] es el nombre, datosPersonales[1] es el apellido)
